...
function multiPick(arr, min, max) {
...
function buildStatuses(count, pattern) {
...
async function main() {
    ...
    const [evtCount, regantCount, regCount, profCount, payCount, contactCnt, interactCnt, webhookCnt,] = await Promise.all([
